...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_4, col_cyan, col_1  },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_1, "-nf", col_3, "-sb", col_cyan, "-sf", col_4, NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_y,      setlayout,      {.v = &layouts[13]} },
